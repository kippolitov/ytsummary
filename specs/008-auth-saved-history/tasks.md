...
- Within US1: T010–T017 (tests) in parallel; T020/T021 in parallel; T018/T019 in parallel with each other but not with T020/T021 (different files, no shared dependency conflict — safe to run all four together)
- Within US2: T026–T030 (tests) in parallel; T034 depends on T033 so not parallel with it
- Within US3: T037–T041 (tests) in parallel
...
Task: "Unit tests for allowedUsersStore.ts in functions/tests/unit/allowedUsersStore.test.ts"
